...
<?php
        ...
        if(isset($_GET['publisher_id']))
        {
            ...
            //get the title based on publisher id
            $sql = "SELECT title FROM tbl_publisher WHERE id= $publisher_id";
...
?>
    ...
    <section class="book-search text-center">
        <div class="container">
            <br>
            <h2>Books from <a href="#" >"<?php echo $publisher_title; ?>"</a></h2>
    ...
    <section class="book-menu">
        <div class="container">
            ...
            <?php 
                //create sql query to get book based on selected publisher

                $sql2 = "SELECT * FROM tbl_book WHERE publisher_id =$publisher_id" ;
                            ...
                            <div class="book-menu-img">
                                            <?php
                                                ...
                                                else
                                                {
                                                    //image available
                                                    ?>
                                                    <img src="<?php echo SITEURL;?>images/book/<?php echo $image_name;?>" alt="book1" class="img-book img-curve-book">
                                                    <?php
