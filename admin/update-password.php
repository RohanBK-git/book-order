...
<div class="main-content">
    ...
    <?php
        ...
        if(isset($_POST['submit']))
        {
            ...
            if($res==true)
            {
                //check whether the data is availiable or not
                 ...
                 if ($new_password == $confirm_password)
                 {
                    ...
                    if($res2==true)
                    {
                       ...
                       header('location:'.SITEURL.'admin/manage-admin.php');
                        ...
                        //error message
                        $_SESSION['change-pwd'] = "<div class='error'>Password chang unsuccessfully</div>";
                        //redirect the user
                       header('location:'.SITEURL.'admin/manage-admin.php');
                    }
                ...
                {
                 //user not found message and redirecting
            ...
            //4.Change password if all above conditions are true
        }
