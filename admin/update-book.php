...
<?php 
    ...
    if(isset($_GET['id']))
    {
        ...
        $current_publisher = $row2['publisher_id'];
            ...
            <tr>
                ...
                <td>
                    <select name="publisher">
                        ...
                        <?php 
                            //Query to Get ACtive Categories
                            $sql4 = "SELECT * FROM tbl_publisher WHERE active='Yes'";
                            //Execute the Query
                            ...
                            if($count4>0)
                            {
                                ...
                                {
                                    $publisher_title = $row4['title'];
                                    $publisher_id = $row4['id'];
                                    
                                    //echo "<option value='$category_id'>$category_title</option>";
                                    ?>
                                    <option <?php if($current_publisher==$publisher_id){echo "selected";} ?> value="<?php echo $publisher_id; ?>"><?php echo $publisher_title; ?></option>
                                    <?php
                                }
                            }
                            else
                            {
                                //CAtegory Not Available
                                echo "<option value='0'>Publisher Not Available.</option>";
                            }
